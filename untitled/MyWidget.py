...
class MyWidget(QtCore.QObject):
    def __init__(self):
        ...
        self.ui.lineEdit.textChanged[str].connect(self.set_label_text)
        self.ui.textEdit.textChanged.connect(self.update_combobox)
        
        # connect the singal to an anonymous function defined by lambda expression
        self.ui.aboutButton.clicked.connect(lambda: QtGui.QMessageBox.about(self.ui, "Python Qt Example", "This program displays a UI which is loaded from a .ui file generated by Qt Creator."))
